...
class Anmeldung
{
    ...
    public function getAnmeldungen()
    {
        ...
        $result = $DB->query('SELECT * FROM `connection` inner join anmeldungen on anmeldungen.spielerid = connection.spielerid inner JOIN gaeste on gaeste.gaesteid = connection.gaesteid');
